...
<body>
  <nav class="navbar dark-primary">
    <div class="container">
      <div class="dropdown">
        <button class="navbar-nama d-flex align-items-center gap-3" data-bs-toggle="dropdown">
          <img src="img/profile-pict/<?= $profil ?>" alt="Foto Profil" class="d-inline-block align-text-top rounded-circle" />
          <?= $nama ?>
        </button>
